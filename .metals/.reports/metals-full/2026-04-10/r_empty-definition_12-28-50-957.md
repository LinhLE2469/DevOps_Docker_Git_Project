error id: file://<WORKSPACE>/backend/src/test/java/fr/takima/training/sampleapplication/IT/DepartmentControllerTestIT.java:fr/takima/training/simpleapi/SimpleApiApplication#
file://<WORKSPACE>/backend/src/test/java/fr/takima/training/sampleapplication/IT/DepartmentControllerTestIT.java
empty definition using pc, found symbol in pc: fr/takima/training/simpleapi/SimpleApiApplication#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 86
uri: file://<WORKSPACE>/backend/src/test/java/fr/takima/training/sampleapplication/IT/DepartmentControllerTestIT.java
text:
```scala
